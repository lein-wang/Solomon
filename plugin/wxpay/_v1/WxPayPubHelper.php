...
require_once dirname(__FILE__) . '/SDKRuntimeException.php';
require_once dirname(__FILE__).'/WxPay.pub.config.php';
 ...
 * 红包发放
 */
 class RedPackage extends Wxpay_client_pub{
 	function __construct() 
	{
		//设置接口链接
	...
	function createXml()
	{
		//echo $this->getSign($this->parameters);exit;
		try
		{
...
class Refund_pub extends Wxpay_client_pub
{
	...
	function createXml()
	{
		...
		{
			//检测必填参数
			if( $this->parameters["transaction_id"] == null && $this->parameters["out_trade_no"] == null ) {
