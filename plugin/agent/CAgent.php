...
class CAgent {
	...
	{
		if (is_file(USERAGENT_PATH.'/config/userAgents.php'))
		{
			include(__DIR__ . '/config/userAgents.php');
		}
		else
		{
			return FALSE;
    ...
    public function is_pc($key=null)
    {
        return (!$this->is_mobile() && $this->is_browser())?true:false;
    }
