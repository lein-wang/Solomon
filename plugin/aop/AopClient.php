...
/** 
	...
	function parserJSONSign($responseJSon) {
	    if(property_exists($responseJSon,'sign')){
	        return $responseJSon->sign;
	    }else{
	        $errcode = $responseJSon->alipay_fund_trans_toaccount_transfer_response->code;
	        $msg = $responseJSon->alipay_fund_trans_toaccount_transfer_response->sub_msg;
	        $data = array('status'=>0,'message'=>$errcode.":".$msg);
