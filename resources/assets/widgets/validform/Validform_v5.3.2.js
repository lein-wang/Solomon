...
;(function($,win,undef){
	...
	var GLOBAL = null; //Validform的全局实例
	var Validform=function(forms,settings,inited){
		...
		GLOBAL.validated = true; //标识验证是否成功
		...
		forms.each(function(){
			...
			$this.delegate("[datatype]","blur click change",function(){
				...
				GLOBAL.validated = Validform.util.check.call(this,$this,subpost);
			});
			...
			$this.submit(function(){
				...
				GLOBAL.validated = subflag;
				return curform.settings.onlyValid ||curform.settings.ajaxPost ? false: true;
			});
			...
			*/
			...
			if(ajaxurl && !Validform.util.isEmpty.call($(this),inputval) && !bool){
				...
				var localconfig={
					...
					cache:false,
					url: ajaxurl,
					data: "val="+encodeURIComponent(inputval)+"&key="+encodeURIComponent($(this).attr("name")),
